...
// Adaptaciones (sandez): descansos más largos en los básicos (180s en los AMRAP de apertura, 120s en los compuestos principales; los accesorios siguen a 90s).
// Adaptaciones (sandez): añadido dia4 = CARDIO Z2 continuo 25-30 min para hacer en un día libre. El archivo tiene 4 días aunque el código del catálogo sea 3D.

// Contenido de app_datos.js

// =================================================================================
// DATOS DE LA RUTINA (3 DÍAS + CARDIO Z2)
// =================================================================================
const workoutData = {
    "dia1": {
        name: "Anterior HIIT",
        ...
        exercises: [
            {
                ...
                reps: "1800s",
                rest: "0s",
                notes: "25-30 minutos CONTINUOS, sin parar. Ritmo Z2: debes poder hablar frases enteras sin quedarte sin aire. Si te falta el aire, baja el ritmo. Hazlo en un día libre, no el mismo día que entrenas.",
                videoUrl: "https://youtu.be/KKvRtNn904g",
                imageUrl: "https://i.ytimg.com/vi/KKvRtNn904g/mqdefault.jpg"
            }
        ]
...
const exerciseAlternatives = {
    ...
    "CARDIO - Correr (Suave)": [
        { name: "CARDIO - Bicicleta (Ritmo Suave)", videoUrl: "https://www.youtube.com/watch?v=r6iTJGOftHY", imageUrl: "https://i.ytimg.com/vi/r6iTJGOftHY/mqdefault.jpg" }
    ],
